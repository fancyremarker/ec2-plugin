...
public class TemplateLabelsTest extends HudsonTestCase{
	...
	public void setUp() throws Exception{
		super.setUp();
		SlaveTemplate template = new SlaveTemplate("ami", "foo", "default", "zone", "22", InstanceType.M1Large, LABEL1 + " " + LABEL2, "foo ami", "tag", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g", true);
	...
	public void testLabelExpression() throws Exception{
        ...
        public void testEmptyLabel() throws Exception{
            SlaveTemplate temp = new SlaveTemplate("ami", "foo", "default", "zone", "22", InstanceType.M1Large, "", "foo ami", "tag", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g", true);
            List<SlaveTemplate> templates = new ArrayList<SlaveTemplate>();
            templates.add(temp);
            ac = new AmazonEC2Cloud("us-east-1", "abc", "def", "ghi", "3", templates);
